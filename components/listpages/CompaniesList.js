    ...
    <div>
      {content?.data &&
        ...
        content?.data?.map((item) => {
          return (
            <Link
              href={"/companies/" + item.attributes.pageslug}
              key={item.attributes.pageslug}
            >
              <div className={`${style.listItem} rounded-lg`}>
                ...
                <div className={`${style.listContent} flex-auto`}>
                  <p className={`${style.summary} flex items-center`}>
                    ...
                    {item.attributes.main_branch.data?.attributes?.city
                      ? ", " +
                        item.attributes.main_branch.data?.attributes?.city
                      : ""}
                  ...
                  <p className={`${style.meta}`}>
                    {item.attributes.hr_court
                      ? item.attributes.hr_court + " | "
                      : ""}
                    {item.attributes.hr_dept} {item.attributes.hr_number}
                  </p>
                </div>
              </div>
            </Link>
